...
export class TechnologyComponent {
  ...
  use_society: String = "Heat batteries will be a key player in overcoming the mismatch between supply and demand of heat. Think about traversing the distance from an industrial plant that produces waste heat to a home that can use this waste heat, or a solar collector that stores heat during the day and uses this in the evening to provide hot water for showering. Heat batteries could also capture the heat generated by large data centers, thereby cooling them down and making data centers more sustainable. In addition to overcoming the mismatch between supply and demand, heat batteries can provide heat in situations where a permanent connection to a heat grid is unfeasible. These situations include modular buildings, the shipping industry or remote housing. The versatility of thermochemical storage."
  ...
  advantages: String = "We already learned that thermochemical heat batteries store heat without any heat loss. However, thermochemical heat batteries made from salt hydrates and water vapor offer many more benefits. Salts such as potassium carbonate are cheap and are widely available, unlike many of the materials used for electrical batteries such as lithium or zinc that can only be obtained in certain areas in the world. Next, due to the relatively high energy density of thermochemical materials in combination with the lack of heat loss, the battery and, consequently, the heat can be transported over large distances with relative ease. Lastly, the salts used can be recycled easily and are generally non-toxic. Thus, thermochemical heat storage is sustainable and safe, making them perfectly suited for in-home usage."
